...
func generate_script_from_data(shot_data: DialogueShot) -> String:
    ...
    script_lines.append("# Konado Scripts is a domain-specific language (DSL)")
    script_lines.append("# specifically designed by StarryTeam for visual novel games.")
    script_lines.append("# Please open this file with VSCode to view the script.")
    script_lines.append("# For more information, please visit https://godothub.com/konado/")
    script_lines.append("#############################################################################")
    script_lines.append("")
